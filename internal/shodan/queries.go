...
func AllQueries() []Query {
	return []Query{
		...
		},
		{
			...
			Raw:         `http.html:"open-webui" |http.title:"Open WebUI"`,
		...
		},
		{
			...
			Raw:         `port:8000 "heartbeat" |http.html:"api/v1/collections"`,
		...
		},
		{
			...
			Raw:         `http.html:"n8n" port:5678 |http.title:"n8n"`,
		...
		},
		{
			...
			Raw:         `http.html:"trycloudflare.com" |http.html:"ngrok" http.html:"ollama"`,
		...
		// ── inference ────────────────────────────────────────────────────────
		{
			...
			Raw:         `"OpenAI-compatible" "chat/completions" |http.html:"vLLM"`,
		...
		},
		{
			...
			Raw:         `http.title:"text-generation-inference" |"Text Generation Inference"`,
		...
		},
		{
			...
			Raw:         `http.title:"Text Generation WebUI" |http.html:"llama.cpp"`,
		...
		// ── vector-db ────────────────────────────────────────────────────────
		{
			...
			Raw:         `"Qdrant" port:6333 |http.html:"Qdrant" "collections"`,
		...
		},
		{
			...
			Raw:         `http.title:"Weaviate Console" |http.html:"Welcome to Weaviate"`,
		...
		},
		{
			...
			Raw:         `http.title:"Milvus Insight" |http.html:"Milvus"`,
		...
		},
		{
			...
			Raw:         `http.html:"/v1/embeddings" "top_k" |"semantic search" "top_k"`,
		...
		},
		{
			...
			Raw:         `product:"Elasticsearch" |http.title:"Kibana"`,
		...
		},
		{
			...
			Raw:         `http.title:"Airflow" |http.html:"Apache Airflow"`,
		...
		},
		{
			...
			Raw:         `http.title:"Jaeger UI" |http.title:"Grafana Tempo"`,
		...
		// ── rag ──────────────────────────────────────────────────────────────
		{
			...
			Raw:         `http.title:"Swagger UI" "/chat" "/embeddings" |http.html:"/rag/query" |http.html:"/documents/upload"`,
		...
		},
		{
			...
			Raw:         `http.title:"FastAPI - Swagger UI" |"Server: uvicorn"`,
